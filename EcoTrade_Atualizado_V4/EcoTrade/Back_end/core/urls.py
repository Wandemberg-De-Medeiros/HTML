...
urlpatterns = [
    ...
    # path('cadastro/', views.cadastro_view, name='cadastro'), # Removido a pedido do cliente
    ...
    path('historico_creditos/', views.historico_creditos_view, name='historico_creditos'), # Novo Histórico de Créditos
]
# 5. Rota da API Pública
path('api/creditos/', views.api_creditos_view, name='api_creditos'),
